function nls_path_plotter(ep,k0,kval,K,Llx,tf)
    ...
    [xtrack0,ztrack0,xmtrack0,zmtrack0,zdiff0,u0,sdrift0] = nls_stepper(K,Llx,ad,anl,cg,k0,kval,Om,0,sig,ep,tf,dt);
    disp(sign(ad/anl))
        
    [Om,cg,ad,anl] = param_maker(k0,omval,sig);
    [xtrack1,ztrack1,xmtrack1,zmtrack1,zdiff1,~,sdrift1] = nls_stepper(K,Llx,ad,anl,cg,k0,kval,Om,omval,sig,ep,tf,dt);
    disp(omval*(2*Om-omval)/(1+cg*omval))
    
    [Om,cg,ad,anl] = param_maker(k0,-omval,sig);
    [xtrackn1,ztrackn1,xmtrackn1,zmtrackn1,zdiffn1,~,sdriftn1] = nls_stepper(K,Llx,ad,anl,cg,k0,kval,Om,-omval,sig,ep,tf,dt);
    disp(-omval*(2*Om+omval)/(1-cg*omval))
